...
params_n_vP <- list(dt = 1, species_no = 4,  gene_no = 5, Pop_ini = c(100,700,100,100), Pop_eq = c(200,300,300,200), capacity = 1000, Genotypes = cbind(c(1,0,0,0,0),c(0,0,1,0,0),c(1,0,0,1,1),c(0,0,0,1,1)), sigma = 0.02) 
