...
combined_compare <- function(state, observed, pars = NULL) {
  ...
  #  result <- result + ll_pois(observed[as.character(ind)], state[1+i, , drop = TRUE])
  #}
  result <- result + ll_pois(observed$"1", state[2, , drop = TRUE])
  result <- result + ll_pois(observed$"2", state[3, , drop = TRUE])
  result <- result + ll_pois(observed$"3", state[4, , drop = TRUE])
  result <- result + ll_pois(observed$"4", state[5, , drop = TRUE])
  result <- result + ll_pois(observed$"5", state[6, , drop = TRUE])
  result <- result + ll_pois(observed$"6", state[7, , drop = TRUE])
  result <- result + ll_pois(observed$"7", state[8, , drop = TRUE])
  result <- result + ll_pois(observed$"8", state[9, , drop = TRUE])
  result <- result + ll_pois(observed$"9", state[10, , drop = TRUE])
  result <- result + ll_pois(observed$"10", state[11, , drop = TRUE])
  result <- result + ll_pois(observed$"11", state[12, , drop = TRUE])
  result <- result + ll_pois(observed$"12", state[13, , drop = TRUE])
  result <- result + ll_pois(observed$"13", state[14, , drop = TRUE])
  result <- result + ll_pois(observed$"14", state[5, , drop = TRUE])
  result <- result + ll_pois(observed$"15", state[16, , drop = TRUE])
  result <- result + ll_pois(observed$"16", state[17, , drop = TRUE])
  result <- result + ll_pois(observed$"17", state[18, , drop = TRUE])
  result <- result + ll_pois(observed$"18", state[19, , drop = TRUE])
  result <- result + ll_pois(observed$"19", state[20, , drop = TRUE])
  result <- result + ll_pois(observed$"20", state[21, , drop = TRUE])
  result <- result + ll_pois(observed$"21", state[22, , drop = TRUE])
  result <- result + ll_pois(observed$"22", state[23, , drop = TRUE])
  result <- result + ll_pois(observed$"23", state[24, , drop = TRUE])
  result <- result + ll_pois(observed$"24", state[25, , drop = TRUE])
  result <- result + ll_pois(observed$"25", state[26, , drop = TRUE])
  result <- result + ll_pois(observed$"26", state[27, , drop = TRUE])
  result <- result + ll_pois(observed$"27", state[28, , drop = TRUE])
  result <- result + ll_pois(observed$"28", state[29, , drop = TRUE])
  result <- result + ll_pois(observed$"29", state[30, , drop = TRUE])
  result <- result + ll_pois(observed$"30", state[31, , drop = TRUE])
  result <- result + ll_pois(observed$"31", state[32, , drop = TRUE])
  result <- result + ll_pois(observed$"32", state[33, , drop = TRUE])
  result <- result + ll_pois(observed$"33", state[34, , drop = TRUE])
  result <- result + ll_pois(observed$"34", state[35, , drop = TRUE])
  result <- result + ll_pois(observed$"35", state[36, , drop = TRUE])
  result <- result + ll_pois(observed$"36", state[37, , drop = TRUE])
  result <- result + ll_pois(observed$"37", state[38, , drop = TRUE])
  result <- result + ll_pois(observed$"38", state[39, , drop = TRUE])
  result <- result + ll_pois(observed$"39", state[40, , drop = TRUE])
  result <- result + ll_pois(observed$"40", state[41, , drop = TRUE])
  result <- result + ll_pois(observed$"41", state[42, , drop = TRUE])
  result <- result + ll_pois(observed$"42", state[43, , drop = TRUE])
  result <- result + ll_pois(observed$"43", state[44, , drop = TRUE])
  result <- result + ll_pois(observed$"44", state[45, , drop = TRUE])
  result <- result + ll_pois(observed$"45", state[46, , drop = TRUE])
  result <- result + ll_pois(observed$"46", state[47, , drop = TRUE])
  result <- result + ll_pois(observed$"47", state[48, , drop = TRUE])
  result <- result + ll_pois(observed$"48", state[49, , drop = TRUE])
  result <- result + ll_pois(observed$"49", state[50, , drop = TRUE])
  result <- result + ll_pois(observed$"50", state[51, , drop = TRUE])
  result <- result + ll_pois(observed$"51", state[52, , drop = TRUE])
  result <- result + ll_pois(observed$"52", state[53, , drop = TRUE])
  result <- result + ll_pois(observed$"53", state[54, , drop = TRUE])
  result <- result + ll_pois(observed$"54", state[55, , drop = TRUE])
  result <- result + ll_pois(observed$"55", state[56, , drop = TRUE])
  result <- result + ll_pois(observed$"56", state[57, , drop = TRUE])
  result <- result + ll_pois(observed$"57", state[58, , drop = TRUE])
  result <- result + ll_pois(observed$"58", state[59, , drop = TRUE])
  result <- result + ll_pois(observed$"59", state[60, , drop = TRUE])
  result <- result + ll_pois(observed$"60", state[61, , drop = TRUE])
  result <- result + ll_pois(observed$"61", state[62, , drop = TRUE])
  result <- result + ll_pois(observed$"62", state[63, , drop = TRUE])
