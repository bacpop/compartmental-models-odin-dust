...
r_output(readLines(file.path("WrightFisher_nGenotypes_haploid_PopsizeConstant.R")))
```
...
```{r}
WF_nG_h <- odin.dust::odin_dust("WrightFisher_nGenotypes_haploid_PopsizeConstant.R")
```
