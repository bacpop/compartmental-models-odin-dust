...
saveRDS(delta_ranking, file = "prev_delta_ranking.rds")
saveRDS(mass_consensus_presence_absence, file = "prev_mass_consensus_presence_absence.rds")
saveRDS(mass_cluster_freq_1, file = "prev_mass_cluster_freq_1.rds")
saveRDS(mass_cluster_freq_2, file = "prev_mass_cluster_freq_2.rds")
saveRDS(mass_cluster_freq_3, file = "prev_mass_cluster_freq_3.rds")
```
...
```{r}
make_lollipop_plot_VTtogether <- function(clusters,data1, data2, data3, model1, model2, model3){
...
```{r}
make_lollipop_plot_VTtogether(1:mass_clusters,data1 = mass_cluster_freq_1, data2 = mass_cluster_freq_2, data3= mass_cluster_freq_3, model1 = x[,1,1], model2 = x[,1,37], model3 = x[,1,73])
```
