...
params_Nepal <- list(dt = 1/36, species_no = no_Nepal_PP,  gene_no = nrow(Nepal_ggCaller_intermed_consensus)-1, Pop_ini = as.double(Nepal_model_start_pop), Pop_eq = as.double(Nepal_model_start_pop), capacity = sum(Nepal_model_start_pop), Genotypes = Nepal_ggCaller_intermed_consensus_matrix, sigma_f = 0.1789665082, sigma_w = 0.0006039627, prop_f = 0.3669067334 , delta = Nepal_delta_ranking, m = 0.0078524723 , migVec = Nepal_avg_cluster_freq, vaccTypes = Nepal_VT, v = 0.1103623064, vacc_time = 9)
```
