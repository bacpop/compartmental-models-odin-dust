...
ggCsero_model1_VT <- ggC_model_val1[which(mass_VT==1)]
ggCsero_model1_NVT <- ggC_model_val1[which(mass_VT==0)]
ggCsero_model2_VT <- ggC_model_val2[which(mass_VT==1)]
ggCsero_model2_NVT <- ggC_model_val2[which(mass_VT==0)]
ggCsero_model3_VT <- ggC_model_val3[which(mass_VT==1)]
ggCsero_model3_NVT <- ggC_model_val3[which(mass_VT==0)]
