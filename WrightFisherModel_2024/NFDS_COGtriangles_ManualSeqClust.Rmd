...
lollipop_cluster_freqs_VTandNVT_labelSero(year = "tp 14 - NVTs", plot_title = "Navajo - Standard vs. VT-divers Model", data_name = "VT data", data1 = mass_NVT_cluster_freq_14/sum(mass_cluster_freq_14), model_name_1 ="VT-divers Model", model1 = simMeanggCPP14_Navajo_NVT/sum(VT_14), VT_vec =  rep(0,mass_clusters), SeroLabel = Navajo_PP_serotype_comp)

lollipop_cluster_freqs_VTandNVT_labelSero_relative(year = "tp 14 - NVTs", plot_title = "Navajo - Standard vs. VT-divers Model", data_name = "VT data", data1 = mass_NVT_cluster_freq_14/sum(mass_cluster_freq_14), model_name_1 ="VT-divers Model", model1 = simMeanggCPP14_Navajo_NVT/sum(VT_14), VT_vec =  rep(0,mass_clusters), SeroLabel = Navajo_PP_serotype_comp)
```
