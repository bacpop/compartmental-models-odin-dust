...
#null_man_sa <- optim_sa(fun = ggCPP_fitting_616, start = start_params, maximization = TRUE, trace = TRUE,lower=c(0.05,0,0,0,0), upper=c(1,0.05,1,1,1), control = c(rf = 2, r = 0.6))
#$par
