...
for (i in 1:73) {
  points((1:mass_clusters)+ ((i-1)*0.01), sim_ggCPP2[,i]/sum(sim_ggCPP2[,i]), col = viridis(73)[i], cex = 1.5)
}
points((1:mass_clusters),sim_ggCPP2[,1]/sum(sim_ggCPP2[,1]), bg = viridis(73)[1], pch = 21, col = "#E69F00", cex = 1.5)
points((1:mass_clusters)+0.36,sim_ggCPP2[,37]/sum(sim_ggCPP2[,37]), bg = viridis(73)[37], pch = 21, col = "#D55E00", cex = 1.5)
points((1:mass_clusters)+0.72,sim_ggCPP2[,73]/sum(sim_ggCPP2[,73]), bg = viridis(73)[73], pch = 21, col = "#CC79A7", cex = 1.5)
points(mass_cluster_freq_1/sum(mass_cluster_freq_1), col = "#E69F00", pch = 19, cex = 1.5)
points((1:mass_clusters)+0.36,mass_cluster_freq_2/sum(mass_cluster_freq_2), col = "#D55E00", pch = 19, cex = 1.5)
points((1:mass_clusters)+0.72,mass_cluster_freq_3/sum(mass_cluster_freq_3), col = "#CC79A7", pch = 19, cex = 1.5)
