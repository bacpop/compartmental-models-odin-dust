...
plot((mass_cluster_freq_14[order(mass_cluster_freq_14)])[which(data_vals!=0)],scaled_error_vals, ylab = "squared error/cluster size", xlab = "Cluster size (data)", main = "Relative Squared error model vs. data for Navajo, tp 14")
