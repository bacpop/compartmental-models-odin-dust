...
fit_616 <- nmkb(start_params, ggCPP_fitting_616, lower=c(0.055,0,0,0,0), upper=c(1,0.055,1,1,1), control = c(maximize = TRUE, trace = TRUE))
...
fit_616 <- nmkb(start_params, COG_fitting_616, lower=c(0.055,0,0,0,0), upper=c(1,0.055,1,1,1), control = c(maximize = TRUE, trace = TRUE))

#$par
#[1] 0.0138223223 0.0014012080 0.0006622993 0.5182582935 0.9826246156
