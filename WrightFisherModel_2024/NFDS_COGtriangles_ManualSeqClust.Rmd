...
```{r}
plot(0.305665235/(1+exp((1774*(0.805942099)-(1:1774)))), main = "Logistic Model Fit with ggCaller and manSeqCl", xlab = "Genes", ylab = "Selection Strength")
points(0.309057542/(1+exp(4.681828437 *(1774*(0.809096221)-(1:1774)))), col = "red")
legend(0, 0.3, legend=c("4 parameter model", "5 parameter model"),
