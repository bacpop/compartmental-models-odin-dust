...
# for this version of the model, delta_bool is used for whether genes are under NFDS or not
...
probs[] <- ((1 + sigma_f)^pi_f_genotypes[i]) * Pop[i] * (1- (as.integer(time >= vacc_time) * vaccTypes[i] * v))
