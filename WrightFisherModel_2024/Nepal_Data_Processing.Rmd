...
plot((names(Nepal_GPSC_numbers_per_year[["1"]])), Nepal_GPSC_numbers_per_year[["1"]], type = "l", ylim = c(0, 80))
for (i in unique(Nepal_seq_clusters_dict)) {
  lines((names(Nepal_GPSC_numbers_per_year[["1"]])), Nepal_GPSC_numbers_per_year[[i]])
}
